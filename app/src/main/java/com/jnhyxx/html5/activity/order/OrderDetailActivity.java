...
public class OrderDetailActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        if (mProduct.isForeign()) {
            String lossProfitRmb = "(" + FinanceUtil.formatWithScaleNoZero(Math.abs(lossProfit * rate)) + mFundUnit + ")";
        ...
        mTradeFee.setText(FinanceUtil.formatWithScaleNoZero(mOrderDetail.getUserFees()) + mProduct.getCurrencyUnit());
        mMargin.setText(FinanceUtil.formatWithScaleNoZero(mOrderDetail.getMarginMoney()) + mProduct.getCurrencyUnit());
