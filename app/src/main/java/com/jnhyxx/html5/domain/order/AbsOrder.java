...
public class AbsOrder {
    ...
    public static final int SELL_OUT_MAKERT_PRICE = 0; // 市价卖出
    public static final int SELL_OUT_STOP_PROFIT = 1;
    public static final int SELL_OUT_STOP_LOSS = 2;
    public static final int SELL_OUT_SYSTEM_CLEAR = 3; // 系统清仓
    public static final int SELL_OUT_MANUALLY = 4; // 人工卖出
}
