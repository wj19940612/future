...
public class IntegralDetailFragment extends ListFragment implements ApiIndeterminate {
    private static final String TAG = "IntegralDetailFragment";
    ...
    public static IntegralDetailFragment newInstance(String type) {
        IntegralDetailFragment mIntegralDetailFragment = new IntegralDetailFragment();
        Bundle bundle = new Bundle();
        bundle.putString(TYPE, type);
        mIntegralDetailFragment.setArguments(bundle);
        return mIntegralDetailFragment;
    }
