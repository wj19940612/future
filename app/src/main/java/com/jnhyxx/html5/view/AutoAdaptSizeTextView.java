...
public class AutoAdaptSizeTextView extends TextView {
    // Scaling factor
    ...
    public AutoAdaptSizeTextView(Context context) {
        super(context);
        initialise();
    }

    public AutoAdaptSizeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialise();
    }
