...
public class BottomTabs extends LinearLayout {
    ...
    private void init() {
        mIcons = new int[]{R.drawable.tab_home, R.drawable.tab_market, R.drawable.tab_information, R.drawable.tab_mine};
        mTexts = new int[]{R.string.home, R.string.market, R.string.information, R.string.mine};
