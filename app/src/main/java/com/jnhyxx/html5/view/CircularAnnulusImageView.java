...
/**
 * Created by wangjie on 2016/8/22.
 * 带圆环的imageView,我的界面的人物头像
 */
...
public class CircularAnnulusImageView extends ImageView {
    ...
    public CircularAnnulusImageView(Context context) {
        super(context);
    }

    public CircularAnnulusImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularAnnulusImageView(Context context, AttributeSet attrs, int defStyle) {
