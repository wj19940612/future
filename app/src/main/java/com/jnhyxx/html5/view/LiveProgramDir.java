...
//        sPopupWindow.setContentView(popupView);
...
//        sPopupWindow.setBackgroundDrawable(new BitmapDrawable(sWeakReference.get().getResources(), (Bitmap) null));
        sPopupWindow.setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(sWeakReference.get(), android.R.color.transparent)));
