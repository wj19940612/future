            ...
            if (mPlayer.isHardware() && mPlayer.isInBackground()) {
                switch (mVideoScalingMode) {
                    case VIDEO_SCALING_MODE_FIT:
                        ...
                        mSetPlayerScaleButton.setImageResource(R.drawable.media_controller_scale01);
                        break;
                    case VIDEO_SCALING_MODE_NONE:
                        mVideoScalingMode = VIDEO_SCALING_MODE_NONE;
                        mSetPlayerScaleButton.setImageResource(R.drawable.media_controller_scale02);
                        break;
                    default:
                        mVideoScalingMode = VIDEO_SCALING_MODE_NONE;
                }
        ...
        if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
            ...
            if (mFromXml) {
                ...
                mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY,
                        anchorRect.left, anchorRect.bottom - getHeight());
            }
            mShowing = true;
